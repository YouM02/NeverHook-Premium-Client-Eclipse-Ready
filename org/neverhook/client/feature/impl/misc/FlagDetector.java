        ...
        if (this.getState()) {
            if (event.getPacket() instanceof SPacketPlayerPosLook) {
                if (NeverHook.instance.featureManager.getFeatureByClass(Speed.class).getState()) {
                    featureAlert("Speed");
                    NeverHook.instance.featureManager.getFeatureByClass(Speed.class).toggle();
                } else if (NeverHook.instance.featureManager.getFeatureByClass(Flight.class).getState()) {
                    featureAlert("Flight");
                    NeverHook.instance.featureManager.getFeatureByClass(Flight.class).toggle();
                    ...
                    NeverHook.instance.featureManager.getFeatureByClass(FastClimb.class).toggle();
                    ...
                    NeverHook.instance.featureManager.getFeatureByClass(TargetStrafe.class).toggle();
                } else if (NeverHook.instance.featureManager.getFeatureByClass(LongJump.class).getState()) {
                    featureAlert("LongJump");
                    NeverHook.instance.featureManager.getFeatureByClass(LongJump.class).toggle();
                    ...
                    NeverHook.instance.featureManager.getFeatureByClass(LiquidWalk.class).toggle();
                } else if (NeverHook.instance.featureManager.getFeatureByClass(Timer.class).getState()) {
                    featureAlert("Timer");
                    NeverHook.instance.featureManager.getFeatureByClass(Timer.class).toggle();
                }
            }
        }
    }
