...
public class KillAura extends Feature {
    ...
    public void onEventPreMotion(EventPreMotion e) {
        if (mc.player.isEntityAlive()) {
            ...
            String mode = NeverHook.instance.getSettingByName("Rotation Mode").getValString();
            target = this.getClosest(NeverHook.instance.featureManager.getSettingByName("Range").getValDouble());
