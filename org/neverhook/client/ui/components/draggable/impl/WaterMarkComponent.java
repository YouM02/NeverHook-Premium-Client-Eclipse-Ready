    ...
    public void render(int mouseX, int mouseY) {
        if (!mc.gameSettings.showDebugInfo) {
            ...
            if (mode.equalsIgnoreCase("Default")) {
                ...
                String text = "never" + ChatFormatting.GREEN + "hook" + ChatFormatting.RESET + " | " + (NeverHook.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() && StreamerMode.ownName.getBoolValue() ? ChatFormatting.LIGHT_PURPLE + "Protected" + ChatFormatting.RESET : ChatFormatting.RESET + "Ya tut kryaknul pomenyay potom") + " | " + Minecraft.getDebugFPS() + "fps | " + server;
                ...
                String text = ChatFormatting.BOLD + NeverHook.instance.name + ChatFormatting.RESET + ChatFormatting.GRAY + " | " + ChatFormatting.RESET + "Ya tut kryaknul pomenyay potom" + ChatFormatting.GRAY + " | " + ChatFormatting.RESET + (NeverHook.instance.featureManager.getFeatureByClass(Disabler.class).getState() ? 0 : Objects.requireNonNull(mc.getConnection()).getPlayerInfo(mc.player.getUniqueID()).getResponseTime()) + "ms" + ChatFormatting.GRAY;
