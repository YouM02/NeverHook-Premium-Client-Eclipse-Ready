...
public class ClientInfoComponent extends DraggableModule {
    ...
    public ClientInfoComponent() {
        super("ClientInfoComponent", sr.getScaledWidth() - mc.robotoRegularFontRender.getStringWidth(NeverHook.instance.type + " - " + ChatFormatting.WHITE + NeverHook.instance.version + ChatFormatting.RESET + " - " + "Ya tut kryaknul pomenyay potom"), sr.getScaledHeight() - 20);
    }
    ...
    public void render(int mouseX, int mouseY) {
        if (HUD.clientInfo.getBoolValue()) {
            ...
            String buildStr = NeverHook.instance.type + " - " + ChatFormatting.WHITE + NeverHook.instance.version + ChatFormatting.RESET + " - " + "Ya tut kryaknul pomenyay potom";
